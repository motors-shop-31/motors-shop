...
export class startMigrations1677846952115 implements MigrationInterface {
    name = 'startMigrations1677846952115'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(250) NOT NULL, "name" character varying(250) NOT NULL, "password" character varying(250) NOT NULL, "cpf" character varying(30) NOT NULL, "birthday" TIMESTAMP NOT NULL, "tel" character varying(30) NOT NULL, "description" character varying(250), "account_type" character varying(250) NOT NULL, "date_creation" TIMESTAMP NOT NULL DEFAULT now(), "date_update" TIMESTAMP NOT NULL DEFAULT now(), "addressId" uuid, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "REL_217ba147c5de6c107f2fa7fa27" UNIQUE ("addressId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
